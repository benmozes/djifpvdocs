...
=== ":material-roman-numeral-1: первое поколение"
    ...
    1. naco.txt + naco\_pwr.txt <a href="https://djifpvdocs.b-cdn.net/naco_files.zip" target="_blank">скачать файлы:material-file-download-outline:</a>
    2. извлечь из архива
        - oчки
...
=== ":material-roman-numeral-2:/:material-roman-numeral-3: второе и третье поколение"
    ...
    1. ham_cfg_support <a href="https://djifpvdocs.b-cdn.net/ham_cfg_support.zip" target="_blank">скачать файл:material-file-download-outline:</a>
    2. извлечь из архива
