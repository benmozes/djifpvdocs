...
??? abstract "список параметров"
    ...
    4. **Частота дисплеев**
        - до 100 Гц
    5. **Диапазон частот**
        - 2.400-2.4835 ГГц :material-information-slab-circle-outline:{ title="используется с аватой в странах где 5.8ГГц не входит в список разрешенных" }
        - 5.725-5.850 ГГц 
