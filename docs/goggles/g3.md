...
### совместимость
* дроны
    * :material-link-off:{ .red_cross } DJI Flip 
    * :material-link:{ .green_check } DJI Avata 2
    * :material-link:{ .green_check } DJI Neo
    * :material-link:{ .green_check } DJI Neo 2
* юниты:
...
* апппаратура управления:
    * :material-link-off:{ .red_cross } RC-N2 Remote Controller
    * :material-link-off:{ .red_cross } RC-N3 Remote Controller
